# Дз 10. Создать бота для вывода текущего курса валют(желательно запрос по конкретной валюте)
# /currency USD
...
def hello_commands(message):
    ...
    bot.send_message(chat_id, "Добро пожаловать! Вас приветствует Бот по текущему курсу валют. Выбери команду '/currency USD' или '/help'")
